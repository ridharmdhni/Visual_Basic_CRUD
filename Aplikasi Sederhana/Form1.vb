...
Public Class Form1
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            bukakoneksi()
            Dim simpan As String = "insert into tbl_mahasiswa values ('" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "', '" & ComboBox.Text & "')"
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        bukakoneksi()
        Dim edit As String = "UPDATE tbl_mahasiswa SET nama_mhs='" & TextBox2.Text & "', alamat_mhs='" & TextBox3.Text & "', telepon_mhs='" & TextBox4.Text & "', jurusan_mhs='" & ComboBox.Text & "' WHERE nim_mhs='" & TextBox1.Text & "'"
